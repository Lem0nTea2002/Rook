...
from rook_agent.context.triggers import ContextCompactionConfig
...
def test_app_user_flow_e2e_reads_file_renames_shares_resumes_and_continues(tmp_path) -> None:
    ...
    share_path = tmp_path / ".rook" / "shares" / "sess_app_flow.md"
    ...
    view = JsonlSessionStore(tmp_path / ".rook").rebuild_session_view("sess_app_flow")
