...
from rook_agent.context.context_builder import ContextBuilder, InvalidCheckpointBoundaryError
...
from rook_agent.context.tool_sequence import InvalidToolCallSequenceError
                ...
                parts=[
                    MessagePart(
                        ...
                        metadata={
                            ...
                            "archive_id": "ar_1",
                            "archive_path": ".rook/archives/sess_test/ar_1.txt",
                        },
                    )
                ],
            )
