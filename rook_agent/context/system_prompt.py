...
from rook_agent.context.identity import content_fingerprint, stable_json_hash
...
class SystemPromptBuilder:
    ...
    def fingerprint(self, inputs: SystemPromptInputs) -> str:
        value = {
            ...
            "project_memory_context_hash": content_fingerprint(
                inputs.project_memory_context
            ),
            "shell_guidance_hash": content_fingerprint(inputs.shell_guidance),
    ...
    def build(self, inputs: SystemPromptInputs) -> PromptPrefixCacheEntry:
        ...
        content = "\n\n".join(
            ...
            for section in [
                ...
                _agent_behavior_rules(inputs.shell_guidance),
                _agent_few_shots(),
                ...
                _format_section("Confirmed project memory", inputs.project_memory_context),
...
def _agent_behavior_rules(shell_guidance: str) -> str:
