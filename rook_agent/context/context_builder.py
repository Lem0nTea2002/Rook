...
from rook_agent.context.checkpoint import Checkpoint, CheckpointIndex, checkpoint_summary_content
...
from rook_agent.providers.types import ChatMessage, ToolCall
...
class ContextBuilder:
    ...
    `SessionView` 是 Rook 自己的事实账本，不等于 provider 请求格式。ContextBuilder
...
def _project_assistant_message(
    ...
    *,
    ...
    diagnostics = message.metadata.get("diagnostics")
