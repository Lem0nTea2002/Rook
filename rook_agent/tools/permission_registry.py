...
from rook_agent.permissions.types import PermissionDecision, PermissionDecisionKind, PermissionRequest
...
class PermissionAwareToolRegistry:
    ...
    def preflight(
        ...
        if self.registry.validate(name, arguments) is not None:
            return None
