"""AtCoder online-judge benchmark runner for Rook."""
...
from rook_agent.permissions.types import PermissionAction, PermissionDecision, PermissionDecisionKind, PermissionMode
...
def run_tasks(
    *,
    ...
    model_name: str = "rook-atcoder",
    session_root: str | Path = ".rook-atcoder",
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run Rook on AtCoder tasks and submit solutions for real verdicts.")
    ...
    parser.add_argument("--model-name", default="rook-atcoder", help="Model name recorded in benchmark sessions.")
    parser.add_argument("--session-root", default=".rook-atcoder", help="Directory for Rook benchmark sessions.")
